...
@hide_errors('')
def test_structure_basic_int_test1a_correct_int_0_0_int_lparen_rparen(run_compute):
    correct_answer = eval('u.decode_data("Mw==")')
    student_answer = eval('u.decode_data("Mw==")')
    print(f'is_fixture=True, is_student_file=False, is_instructor_file=False')
    answer = student_answer
    ...
    local_namespace={'array': np.array, 'assert_utilities': assert_utilities, 'student_answer': student_answer, 'instructor_answer': correct_answer, 'rel_tol':tol, 'keys':keys}
    is_success, explanation = eval(msg, {'__builtins__':{}}, local_namespace)
    test_structure_basic_int_test1a_correct_int_0_0_int_lparen_rparen.explanation = explanation
    assert is_success

@hide_errors('')
def test_structure_basic_int_test1a_correct_int_0_1_int_lparen_rparen(run_compute):
    correct_answer = eval('u.decode_data("Mw==")')
    student_answer = eval('u.decode_data("IjMi")')
    print(f'is_fixture=True, is_student_file=False, is_instructor_file=False')
    answer = student_answer
    ...
    local_namespace={'array': np.array, 'assert_utilities': assert_utilities, 'student_answer': student_answer, 'instructor_answer': correct_answer, 'rel_tol':tol, 'keys':keys}
    is_success, explanation = eval(msg, {'__builtins__':{}}, local_namespace)
    test_structure_basic_int_test1a_correct_int_0_1_int_lparen_rparen.explanation = explanation
    assert is_success
