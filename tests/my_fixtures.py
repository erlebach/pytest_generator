...
def load_and_run_module(module_name, directory, function_name, *args, **kwargs):
    ...
    with temporary_directory_change(directory):
        ...
        if hasattr(module, function_name):
            ...
            #print(
                #f"==> {func_to_run=}"
            #)  # modify_args_decorator.<locals>.decorator.<locals>.wrapper
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            ...
            if True:
                ...
                #     c_arg = kwargs["c"]
                #     if (
                #         isinstance(c_arg, (list, np.ndarray)) and len(c_arg) > slice_lg
                #     ):  # Ensure 'c' is list or numpy array
...
def run_compute():
    ...
    def _module(patch_dict, ret, *args, **kwargs):
        ...
        # print(
            # f"Executing in module: {repr(module_name)} function: {repr(function_name)}"
        # )
