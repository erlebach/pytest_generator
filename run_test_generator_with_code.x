...
if [[ "$current_date" < "$due_date" ]] || [[ "$current_date" == "$due_date" ]]; then
    ...
    pytest -s --import-mode='append' tests/test_structure_preprocessed_test_generator_with_code_expand.py
    # pytest -s --import-mode='append' tests/test_structure_preprocessed_test_generator_with_code_expand.py::test_structure_question1_ls_1_list_lbrack_str_rbrack
...
#   >>>> CHANGE MANUALLY
    pytest -s --import-mode='append' tests/test_answers_preprocessed_test_generator_with_code_expand.py
fi
