...
if __name__ == "__main__":
    ...
    answer, Xtrain, ytrain, Xtest, ytest = part_A(part3, Xtrain, ytrain, Xtest, ytest)
    answer, X_bin, y_bin, Xtest_bin, ytest_bin = part_B(
        part3, Xtrain, ytrain, Xtest, ytest
    )
    part_C(part3, X_bin, y_bin, Xtest_bin, ytest_bin)
    part_D(part3, X_bin, y_bin, Xtest_bin, ytest_bin)
