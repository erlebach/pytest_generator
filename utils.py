...
def load_datasets(n_samples: int) -> dict[str, Any]:
    ...
    data["noisy_circles"] = datasets.make_circles(
        n_samples=n_samples, factor=0.5, noise=0.05
    )
    data["noisy_moons"] = datasets.make_moons(n_samples=n_samples, noise=0.05)
    ...
    # Blobs with varied variances random_state = 170
    random_state = 42
    data["varied"] = datasets.make_blobs(
