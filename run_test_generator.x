...
if [[ "$current_date" < "$due_date" ]] || [[ "$current_date" == "$due_date" ]]; then
    ...
    # pytest -s --import-mode='append' tests/test_structure_preprocessed_test_generator_expand.py::test_structure_question7_q1_0_0_dict_lbrack_str_comma_ndarray_rbrack
    pytest -s --import-mode='append' tests/test_structure_preprocessed_test_generator_expand.py
