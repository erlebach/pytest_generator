...
if [[ "$current_date" < "$due_date" ]] || [[ "$current_date" == "$due_date" ]]; then
    ...
    # pytest -s --import-mode='append' tests/test_answers_preprocessed_hw1_expand.py::test_answers_question6_q6_2_dict_lbrack_str_comma_list_lbrack_str_rbrack_rbrack
    # pytest -s --import-mode='append' tests/test_structure_preprocessed_hw1_expand.py
